    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            ...
            function checkScrollAnimations() {
                ...
                sections.forEach({
                    "Home.useEffect.checkScrollAnimations": (section)=>{
                        ...
                        if (isVisible) {
                            ...
                            sectionChildren.forEach({
                                "Home.useEffect.checkScrollAnimations": (child, index)=>{
                                    setTimeout({
                                        "Home.useEffect.checkScrollAnimations": ()=>{
                                            if (index % 2 === 0) {
                                    ...
                                    }["Home.useEffect.checkScrollAnimations"], index * 100);
                                }
                            }["Home.useEffect.checkScrollAnimations"]);
                        } else {
                ...
                navLinks.forEach({
                    "Home.useEffect.checkScrollAnimations": (link)=>{
            ...
            const headerScrollHandler = {
                "Home.useEffect.headerScrollHandler": ()=>{
            ...
            function populateStacks() {
                for(const id in detailedTechStacks){
                    ...
                    if (container) {
                        ...
                        detailedTechStacks[id].forEach({
                            "Home.useEffect.populateStacks": (stack)=>{
            ...
            function setRadialPositions() {
                ...
                icons.forEach({
                    "Home.useEffect.setRadialPositions": (id, index)=>{
                    ...
                    icon.addEventListener('click', {
                        "Home.useEffect": (e)=>{
                            ...
                            if (stackId) {
                                ...
                                if (stackCard) stackCard.scrollIntoView({
                                    behavior: 'smooth',
                                    block: 'center'
                                });
                            }
            ...
            function toggleSingleStack(cardId, shouldOpen) {
                ...
                skillStacksList.querySelectorAll('.tech-stack-container').forEach({
                    "Home.useEffect.toggleSingleStack": (c)=>c.classList.remove('expanded')
                }["Home.useEffect.toggleSingleStack"]);
                skillStacksList.querySelectorAll('.glass-card').forEach({
                    "Home.useEffect.toggleSingleStack": (c)=>{
            ...
            function renderProjects(filter = 'all') {
                ...
                const filteredProjects = filter === 'all' ? PROJECT_DATA : PROJECT_DATA.filter({
                    "Home.useEffect.renderProjects": (p)=>p.category === filter
                }["Home.useEffect.renderProjects"]);
                filteredProjects.forEach({
                    "Home.useEffect.renderProjects": (project)=>{
                        const tagsHtml = project.tags.map({
                            "Home.useEffect.renderProjects.tagsHtml": (tag)=>`<span class="text-xs font-medium bg-gray-700/50 text-gray-300 px-3 py-1 rounded-full border border-gray-600">${tag}</span>`
                        }["Home.useEffect.renderProjects.tagsHtml"]).join('');
                        const projectHtml = `
            ...
            function updateFilterButtons(activeFilter) {
                ...
                buttons.forEach({
                    "Home.useEffect.updateFilterButtons": (button)=>{
                ...
                }["Home.useEffect.updateFilterButtons"]);
            }
            ...
            function formSubmitHandler(e) {
                ...
                btn.disabled = true;
                setTimeout({
                    "Home.useEffect.formSubmitHandler": ()=>{
                        form.reset();
                        ...
                        }["Home.useEffect.formSubmitHandler"], 5000);
                    }
                }["Home.useEffect.formSubmitHandler"], 1500);
            }
            ...
            requestAnimationFrame({
                "Home.useEffect": ()=>{
                    ...
                    renderProjects('all');
                    const portfolioFiltersEl1 = document.getElementById('portfolio-filters');
                    const portfolioGridEl1 = document.getElementById('portfolio-grid');
                    const portfolioFiltersHandler1 = {
                        "Home.useEffect.portfolioFiltersHandler": (e)=>{
                    ...
                    }["Home.useEffect.portfolioFiltersHandler"];
                    const portfolioGridHandler1 = {
                        "Home.useEffect.portfolioGridHandler": (e)=>{
                    ...
                    }["Home.useEffect.portfolioGridHandler"];
                    portfolioFiltersEl1?.addEventListener('click', portfolioFiltersHandler1);
                    portfolioGridEl1?.addEventListener('click', portfolioGridHandler1);
                }
            }["Home.useEffect"]);
            // cleanup
            return ({
...
_s(Home, "a2H45NMsEVRQsYG73U3HZOOJthA=");
_c = Home;
var _c;
